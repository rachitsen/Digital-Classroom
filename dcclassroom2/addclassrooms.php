...
.pcontainer {
  ...
  <div class="mb-3 my-4">
    ...
    <input type="text"  name ="classname" class="form-control" id="classname" required="required">

    <label for="classname" class="form-label my-3" style="color: #610094;" >Enter Subject</label>
    <input type="text"  name="subject" class="form-control" id="classname" required="required" >
    
  <div class="mb-3">
    <label for="classdetails" class="form-label my-3" style="color: #610094;">Enter Classroom Details</label>
    <div class="form-outline">
  <textarea class="form-control"  name = "classdetails" id="classdetails" rows="4" required="required"></textarea>
</div>
  </div>
